...
variable "ssh_username" {
  ...
  default     = "root" # Default SSH username for Ubuntu
  sensitive   = true     # Marked sensitive to hide in logs
}
...
variable "vm_name" {
  ...
  default     = "ridgebot-williamqiao-Template" # Default name for the VM template
}
...
source "vsphere-clone" "centos-rb" {
...
build {
  ...
  sources = ["source.vsphere-iso.centos-rb"]
